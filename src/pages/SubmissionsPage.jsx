...
const SubmissionsPage = () => {
      ...
      try {
        ...
        const enrichedSubmissions = submissionsData.map(submission => {
          ...
          return {
            ...
            comments: Math.floor(Math.random() * 10), // Mock data for now
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">All Submissions</h1>
      ...
      {!loading && !error && filteredSubmissions.length === 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-500 mb-6">Try adjusting your filters or check back later for new submissions.</p>
        </div>
      )}

      {/* Submissions Grid */}
      {!loading && filteredSubmissions.length > 0 && viewMode === 'grid' && (
      ...
      {/* Submissions List */}
      {!loading && filteredSubmissions.length > 0 && viewMode === 'list' && (
