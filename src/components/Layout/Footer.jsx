      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/challenges" className="text-sm text-gray-600 hover:text-indigo-600">
                  Challenges
                </Link>
              </li>
              <li>
                <Link to="/tutorials" className="text-sm text-gray-600 hover:text-indigo-600">
                  Tutorials
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/discord" className="text-sm text-gray-600 hover:text-indigo-600">
                  Discord
                </Link>
              </li>
              <li>
                <Link to="/events" className="text-sm text-gray-600 hover:text-indigo-600">
                  Events
                </Link>
              </li>
              <li>
                <Link to="/forum" className="text-sm text-gray-600 hover:text-indigo-600">
                  Forum
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/cookies" className="text-sm text-gray-600 hover:text-indigo-600">
                  Cookie Policy
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="mt-2 text-sm text-gray-500">
                © {new Date().getFullYear()} LeetUIUX. All rights reserved.
              </p>
            </div>
